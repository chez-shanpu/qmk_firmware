...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    GUI_T(KC_LANG2),  KC_LALT, SFT_T(KC_SPACE), KC_FN, KC_ENTER, KC_RALT, GUI_T(KC_LANG1)
  ),
  [_FN] = LAYOUT(
    ...
    _______, _______, _______, _______, _______, _______,  KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, _______, _______, KC_ENTER,
